...
class Diwani extends StatefulWidget {
  @override
  _DiwaniState createState() => _DiwaniState();
}

class _DiwaniState extends State<Diwani> {
                  ...
                  child: ListView(
                    children: <Widget>[
                      Container(
                        ...
                        child: Image.asset(
                          "img/subcat/diwani/02_buttons_01.png",
                          //fit: BoxFit.cover,
                        ),
                      ),
                      Row(
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_03.png",
                                ),
                              ),
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_02.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_05.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_04.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_07.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/diwani/02_buttons_06.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
