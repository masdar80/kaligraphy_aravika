...
class farsi extends StatefulWidget {
  @override
  _farsiState createState() => _farsiState();
}

class _farsiState extends State<farsi> {
                  ...
                  child: ListView(
                    children: <Widget>[
                      Container(
                        ...
                        child: Image.asset(
                          "img/subcat/farsi/04_buttons_01.png",
                          //fit: BoxFit.cover,
                        ),
                      ),
                      Row(
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_03.png",
                                ),
                              ),
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_02.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_05.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_04.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_07.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
                          ...
                          InkWell(
                            child: Stack(children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(
                                  "img/subcat/farsi/04_buttons_06.png",
                                ),
                              ),
                              Column(children: <Widget>[
                                //first element in column is the transparent offset
